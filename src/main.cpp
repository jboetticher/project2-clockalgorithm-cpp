...
void test2(File &file1, File &file2, File &file3) {
  ...
  for (i = 0; i < num / 3; i++) {
    ...
    // std::cout << "    unPinPage(file1..) \n";
    bufMgr->unPinPage(file1, pageno1, false);
  }

  // std::cout << "    unpin twos and threes \n";
  for (i = 0; i < num / 3; i++) {
